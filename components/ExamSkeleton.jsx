  ...
  return (
    <>
      ...
      <View className="items-center p-4 mb-6">
        ...
        {/* Exam Title */}
        <SkeletonBox height={28} width="70%" className="mt-6 mb-4" />
        {/* Description */}
        <SkeletonBox height={18} width="90%" className="mb-2" />
        <SkeletonBox height={18} width="85%" className="mb-2" />
        {/* Question Count */}
        <SkeletonBox height={28} width={200} className=" mb-6" radius={14} />
        {/* Subscription Info */}
        <View className="bg-indigo-50 w-full  rounded-2xl p-5 mb-8">
