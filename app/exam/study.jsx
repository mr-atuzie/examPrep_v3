...
export default function StudyScreen() {
  ...
  const confirmSwitchMode = () => {
    ...
    Alert.alert(
      ...
      "You're about to switch this exam from Study Mode to Timed Mode. All current progress and answers will be lost. Do you want to continue?",
      [
        { text: "Cancel", style: "cancel" },
        { text: "Switch", onPress: () => setExamMode("timed") },
      ]
    );
  };
    ...
    return (
      <ScreenWrapper backgroundColor={"#1E4B9B"}>
        <View className="flex-1 justify-center items-center">
          <Text className="text-white text-body tracking-wide">
          ...
          <TouchableOpacity
            ...
            onPress={handleLeave}
          >
            <Text className="text-blue-900">Go Back</Text>
          </TouchableOpacity>
        </View>
      </ScreenWrapper>
    );
    ...
    <ScreenWrapper backgroundColor={"#1E4B9B"} statusBarStyle="light-content">
      ...
      <View className=" relative p-4 flex-col gap-4  ">
        ...
        <View className="flex-row justify-between items-center    bg-white/10 px-8 py-2 rounded-md">
          ...
          >
            <Ionicons name="alarm" size={22} color={"white"} />
